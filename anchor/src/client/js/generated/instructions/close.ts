...
export type CloseInput<
  ...
  TAccountPoker extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountPoker>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountPoker> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.poker),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountPoker>;
